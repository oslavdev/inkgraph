          ...
          >
            <div>
              ...
              <p style={{ fontSize: 14, color: "#555", lineHeight: 1.8, margin: "0 0 12px" }}>
                ...
                revealing text line by line, choosing responses, and branching through your tree in
                real time.
              </p>
            ...
            >
              ...
              >
                <span
                  style={{ fontSize: 10, fontFamily: "monospace", color: ACCENT, letterSpacing: 1 }}
                >
                  SIMULATOR
                </span>
                <span
              ...
              <div
                style={{ padding: "20px 18px", display: "flex", flexDirection: "column", gap: 14 }}
              >
                {/* Past line */}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 6, marginTop: 4 }}>
                  {["Tell me more about this traveller", "I haven't seen anyone like that"].map(
                    (label, i) => (
                      <div
                        key={label}
                        style={{
